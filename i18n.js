...
(function () {
    ...
    const EN = {
        ...
        'skills.ai.chatwoot': 'Chatwoot (live chat & support)',
        'skills.ai.redis': 'Redis / Upstash (cache & sessions)',
        'skills.dev.title': 'Development & Infrastructure',
        'skills.dev.stripe': 'Stripe (payments & subscriptions)',
        'skills.pm.title': 'Project Management',
        'skills.pm.docs': 'Technical and functional documentation',
        'skills.soft.title': 'Soft Skills',
        'skills.soft.s1': 'Team Leadership',
        'skills.soft.s2': 'Effective Communication',
        'skills.soft.s3': 'Stakeholder Management',
        'skills.soft.s4': 'Problem Solving',
        'skills.soft.s5': 'Strategic Thinking',
        'skills.soft.s6': 'Negotiation',
        'skills.soft.s7': 'Adaptability',
