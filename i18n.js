...
(function () {
    ...
    const EN = {
        ...
        'exp.t2x.date': '2024 - Present',
        'exp.t2x.bullets': '<li>Founded and lead an agency specialized in AI agents and automation.</li><li>Design and development of WhatsApp conversational AI agents for B2B clients in industries such as healthcare, tax, banking, politics and sports.</li><li>Solution architecture with n8n, LLMs, RAG pipelines and the WhatsApp Business API.</li><li>Management of international clients (Germany, Spain).</li>',
        'exp.xoor.company': 'Xoor | Software Factory | Las Vegas, USA (remote)',
        'exp.xoor.bullets': '<li>Led a team of 8 people building an AI platform + chatbot that processed leads from text, audio and images.</li><li>Also served as Functional Analyst: requirements gathering, documentation and backlog definition.</li><li>Delivered the project one month ahead of schedule, enabling an extended beta with real users.</li>',
        'exp.lubee.bullets': '<li>End-to-end management of 5 simultaneous teams (25 people) on web and iOS/Android app projects.</li><li>Also served as Product Owner and Scrum Master: backlog and user story management, and facilitation of agile ceremonies.</li><li>Standardized the deployment process and continuous improvement, significantly reducing production bugs.</li><li>1-on-1s and retrospectives, achieving aligned teams and long-term talent retention.</li>',
        'exp.jula.bullets': '<li>Managed 12 large-scale projects, mostly for the Argentine national government (Precios Justos, ANMAC), reaching the entire population.</li><li>First AI projects in Ecuador and Central America (JudIT).</li><li>End-to-end management of risks, schedules, documentation and goals.</li><li>Trained junior PMs and standardized agile methodologies.</li>',
